'use server';
/**
 * @fileOverview AI-powered tennis swing analysis.
 *
...
const SwingAnalysisInputSchema = z.object({
  videoDataUri: z
    .string()
    .describe(
      "A video of a tennis swing, as a data URI that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'."
    ),
