...
2.  The "correctAnswer" player **MUST NOT** be any of these names: {{#if usedPlayers}}{{#each usedPlayers}}"{{this}}"{{#unless @last}}, {{/unless}}{{/each}}{{else}}None{{/if}}.
3.  The "correctAnswer" player **MUST NOT** be "Gustavo Kuerten", as he is used in the example.
